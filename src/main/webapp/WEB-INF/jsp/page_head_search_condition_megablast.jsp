...
<tiles:insertTemplate template="/WEB-INF/jsp/page_head_template.jsp">
	<tiles:putAttribute name="title"><spring:message code="label.page_title.megablast.condition" /></tiles:putAttribute>
	...
	<tiles:putListAttribute name="javascripts">
		...
		<tiles:addAttribute value="/WEB-INF/jsp/function_search_condition.jsp" />
	</tiles:putListAttribute>
